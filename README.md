...
`Reducers`: A state management  that allows us to write pure functions to manage state changes in a predictable manner.
`Store`: The store contains our state for our application.
- [ ] What is the difference between Application state and Component state? When would be a good time to use one over the other?
... Application state: state can be used everywhere in your app { store }
... Component state: is state only in our component { usestate }
when making an app that you know its going to scale up you should use Application state, for smaller app you should use component..
...
- [ ] What is your favorite state management system you've learned and this sprint? Please explain why!
 As of right now redux.. because I used it all day today and I only started to understand it is when I was taking the sprint..
